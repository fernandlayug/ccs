...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($uploadOk) {
        $sql = "INSERT INTO tbl_capstone (title, abstract, a1_sname, a1_fname, a1_mname, a1_role, submit_date, adviser, poster_path, imrad_path) 
                VALUES ('$title', '$abstract', '$a1_sname', '$a1_fname', '$a1_mname','$a1_role', '$submit_date', '$adviser', '$poster_path', '$imrad_path')";
