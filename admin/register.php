...
<head>
    ...
    <link rel="stylesheet" href="static/ccs/register.css">
...
<div  class="container" id="check" >
    <div class="col-xl-6">
        <label class = "form-control-label" for="emp_id">Enter Employee ID: </label>  
        <input type="text" id="emp_id" name="emp_id " oninput="autoFill()">
        <br>
        <br>
